...
/**
 * @author huangmin <br/>
 * DateTime:2015年11月20日上午11:10:50
 */
public class IdcardUtils {
	...
	//如果是15位的身份证，转成18位
	public static String getFinalCardString(String idCard,String cardType)
	{
		if(null == idCard) return null;
		String idCard18 = idCard;
		try{
			//如果是身份证
			if(idCard.length() == 15 && validateIdCard15(idCard))
			{
				idCard18 = conver15CardTo18(idCard);
	...
	public static  List<String> getIdCardList(String idCard, String cardType) {
		List<String> idCards = new ArrayList<String>();
		idCards.add(idCard);
		idCards.add(getFinalCardString(idCard, cardType));
		return idCards;
	}
}
