...
LOG_DIR=/home/boot/logs/apollo/100003173
## Adjust server port if necessary
SERVER_PORT=9002
## Adjust profile if necessary
APOLLO_PROFILE=prod,auth
...
export JAVA_OPTS="$JAVA_OPTS -Dserver.port=$SERVER_PORT -Dapollo_profile=$APOLLO_PROFILE -Dlogging.file=$LOG_DIR/$SERVICE_NAME.log -Xloggc:$LOG_DIR/gc.log -XX:NumberOfGCLogFiles=5 -XX:GCLogFileSize=5M -XX:HeapDumpPath=$LOG_DIR/HeapDumpOnOutOfMemoryError/"
